...
def select_file_dialog() -> str:
    """Opens a Tkinter file picker dialog to choose a save or JSON file.
...
def create_backup() -> str:
    ...
    try:
        ...
        data: Any = json.loads(decoded_str)
...
def import_save_file(filepath: str) -> str:
